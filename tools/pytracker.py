...
class PyTracker:
    def __init__(self,tracker_type,bbox,cur_frame): #def __init__(self,img_dir,tracker_type,dataset_config):
        ...
        self.tracker.init(cur_frame,bbox)
    
    def track(self,frame,verbose= True):
        current_frame = frame
        ...
        current_frame=cv2.rectangle(current_frame, (int(x1), int(y1)), (int(x1 + w), int(y1 + h)), (255, 0, 0),1)
        return bbox,score
